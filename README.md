# ZCChartline-Chartline
### 一个画折线的库,丰富的自定义折线/曲线类型

## 目前曲线不完美的部分已解决,并且支持图例显示/Y轴永远固定在界面左方显示,气泡数值提示等等,请移驾:https://github.com/voisen/WZCChartLineView
##                            ----更多精彩等待你的发现
...
####如果你在使用过程中,发现了问题,或者有更好的建议,请拼命的给我发邮件
Email:voisen@qq.com